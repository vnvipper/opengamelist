System.register(["@angular/router", "./home.component", "./about.component", "./login.component", "./page-not-found.component", "./item-detail-edit.component", "./item-detail-view.component"], function (exports_1, context_1) {
    ...
    var router_1, home_component_1, about_component_1, login_component_1, page_not_found_component_1, item_detail_edit_component_1, item_detail_view_component_1, appRoutes, AppRoutingProviders, AppRouting;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
